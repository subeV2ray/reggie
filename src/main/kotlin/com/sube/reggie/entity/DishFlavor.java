...
public class DishFlavor implements Serializable {
    ...
    public DishFlavor(long serialVersionUID, Long id, Long dishId, String name, String value, LocalDateTime createTime, LocalDateTime updateTime, Long createUser, Long updateUser, Integer isDeleted) {
        DishFlavor.serialVersionUID = serialVersionUID;
        this.id = id;
        this.dishId = dishId;
        this.name = name;
        this.value = value;
